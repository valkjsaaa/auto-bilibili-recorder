...
RUN dpkgArch="$(uname -m)" && \
    ...
    case "$dpkgArch" in \
        aarch64) \
            URL='https://github.com/BililiveRecorder/BililiveRecorder/releases/download/v2.18.0/BililiveRecorder-CLI-linux-arm64.zip' \
            ;; \
        x86_64) \
            URL='https://github.com/BililiveRecorder/BililiveRecorder/releases/download/v2.18.0/BililiveRecorder-CLI-linux-x64.zip' \
            ;; \
        *) \
